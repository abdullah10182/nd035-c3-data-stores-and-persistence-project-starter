...
public class ScheduleController {
    ...
    public ScheduleDTO createSchedule(@RequestBody ScheduleDTO scheduleDTO) {
        ...
        return Utils.getScheduleDTO(scheduleService.saveSchedule(schedule, scheduleDTO.getEmployeeIds(), scheduleDTO.getPetIds()));
    }

    @GetMapping
    public List<ScheduleDTO> getAllSchedules() {
        List<Schedule> schedules = scheduleService.getAllSchedules();
        return schedules.stream().map(Utils::getScheduleDTO).collect(Collectors.toList());
    }
